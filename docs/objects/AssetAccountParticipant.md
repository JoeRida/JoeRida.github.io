...
```mermaid
graph TD
AssetAccountParticipant["AssetAccountParticipant"]:::mainObject
click AssetAccountParticipant "/objects/AssetAccountParticipant/"
...
| IsActive |  |  | undefined |
| Name |  |  | undefined |
| StakeholderRole |  | Picklist | undefined |
| UsageType |  |  | undefined |
