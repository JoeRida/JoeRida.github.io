...
BranchUnitRelatedRecord["BranchUnitRelatedRecord"]:::mainObject
...
| Comment |  |  | undefined |
| EGH_AccountCustomerLookup__c | Customer | Lookup | Relationship to associate more than one Branch Unit to a single Account |
| EGH_LeadLookup__c | Lead | Lookup | Relationship with a Lead to allow relate one Lead with several Branch Units. |
| Reason |  | Picklist | undefined |
| RelatedObjectName |  |  | undefined |
| RelatedRecordAssocCriteriaId |  | Lookup | undefined |
