...
click START "#general-information" "3987458404"
...
click p_95b9834a_3864_40c0_a22b_854dde24587a "#p_95b9834a_3864_40c0_a22b_854dde24587a" "2404172144"
...
|:---|:---|
|Process Type| Survey|
|Label|Elite Lead Lost Survey Flow|
|Status|Active|
|Interview Label|Elite Lead Lost Survey Flow|
|Start Element Reference|[pageNamesInOrder_Assignment](#pagenamesinorder_assignment)|
| Branding Set (PM)|sb_elite_lead_lost_survey_flow_2_dddb1a00_80e6_4f30_bdbd_aa512591d8b8|
...
|thankYouLabelTextTemplate1|<p><span class="ql-cursor"></span>شكرًا جزيلاً على وقتك! نحن نقدر تعليقاتك وسنستخدمها لتحسين تجاربك المستقبلية.</p>|<!-- -->|
...
|Extension Name|survey:runtimePicklist|
|Field Text|<p><strong>What was the main reason you chose not to proceed with the purchase?<span class="ql-cursor"></span></strong></p>|
|Field Type| Component Choice|
|Is Required|✅|
|Style Properties|verticalAlignment:<br/>&nbsp;&nbsp;stringValue: top<br/>width:<br/>&nbsp;&nbsp;stringValue: 12<br/>|
...
|Extension Name|survey:cmpInputRuntimeCsat|
|Field Text|<p><strong>How would you rate the inter<span class="ql-cursor"></span>action you had with our consultant?</strong></p>|
|Field Type| Component Input|
|Is Required|✅|
|Scale|0|
|Style Properties|verticalAlignment:<br/>&nbsp;&nbsp;stringValue: top<br/>width:<br/>&nbsp;&nbsp;stringValue: 12<br/>|
...
|Extension Name|survey:runtimeRadioButton|
|Field Text|<p><strong>Was the vehicle you were interested<span class="ql-cursor"></span> in available for viewing or test drive?</strong></p>|
|Field Type| Component Choice|
|Is Required|✅|
|Style Properties|verticalAlignment:<br/>&nbsp;&nbsp;stringValue: top<br/>width:<br/>&nbsp;&nbsp;stringValue: 12<br/>|
...
|Data Type|String|
|Process Metadata Values|- name: autoProgressAction<br/>&nbsp;&nbsp;value:<br/>&nbsp;&nbsp;&nbsp;&nbsp;stringValue: NONE<br/>- name: isDeletable<br/>&nbsp;&nbsp;value:<br/>&nbsp;&nbsp;&nbsp;&nbsp;booleanValue: true<br/>- name: isEditable<br/>&nbsp;&nbsp;value:<br/>&nbsp;&nbsp;&nbsp;&nbsp;booleanValue: true<br/>- name: isMovableDown<br/>&nbsp;&nbsp;value:<br/>&nbsp;&nbsp;&nbsp;&nbsp;booleanValue: true<br/>- name: isMovableUp<br/>&nbsp;&nbsp;value:<br/>&nbsp;&nbsp;&nbsp;&nbsp;booleanValue: true<br/>|
|Field Text|<p><strong>Were you considering any other brands or dealerships? If yes, which ones?</strong></p>|
|Field Type| Input Field|
|Is Required|⬜|
|Style Properties|verticalAlignment:<br/>&nbsp;&nbsp;stringValue: top<br/>width:<br/>&nbsp;&nbsp;stringValue: 12<br/>|
...
|Extension Name|survey:runtimePicklist|
|Field Text|<p><strong><span class="ql-cursor"></span>Would you like us to contact you in the future for offers or availability?</strong></p>|
|Field Type| Component Choice|
|Is Required|✅|
|Style Properties|verticalAlignment:<br/>&nbsp;&nbsp;stringValue: top<br/>width:<br/>&nbsp;&nbsp;stringValue: 12<br/>|
