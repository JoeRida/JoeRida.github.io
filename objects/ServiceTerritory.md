...
```mermaid
graph TD
ServiceTerritory["ServiceTerritory"]:::mainObject
click ServiceTerritory "/objects/ServiceTerritory/"
...
| EGH_Location_Map_link__c | Location Map link | Url | This field will store a Google Maps location link. |
| IsActive |  |  | undefined |
| Name |  |  | undefined |
| OperatingHoursId |  | Lookup | undefined |
| OwnerId |  | Lookup | undefined |
| ParentTerritoryId |  | Hierarchy | undefined |
| PricebookId |  | Lookup | undefined |
| SelfCheckInUrl |  |  | undefined |
| ServiceAppointmentLimitType |  |  | undefined |
| TopLevelTerritoryId |  | Lookup | undefined |
| TypicalInTerritoryTravelTime |  |  | undefined |
