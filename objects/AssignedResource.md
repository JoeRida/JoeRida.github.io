...
```mermaid
graph TD
AssignedResource["AssignedResource"]:::mainObject
click AssignedResource "/objects/AssignedResource/"
...
| :-------- | :---- | :--: | :---------- | 
| AssignedResourceNumber |  |  | undefined |
| EventId |  | Lookup | undefined |
| IsPrimaryResource |  |  | undefined |
| IsRequiredResource |  |  | undefined |
| Role |  | Picklist | undefined |
| ServiceAppointmentId |  | MasterDetail | undefined |
